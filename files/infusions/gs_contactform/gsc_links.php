...
opentable('<center>'.$locale['401'].'</center>');
...
// Kontaktformular //
$result = dbquery("SELECT link_id, link_name, link_url, link_visibility, link_order, link_position FROM ".DB_SITE_LINKS." WHERE link_url='infusions/gs_contactform/contactform.php'");
$data = dbarray($result);
		
		if (($data['link_name']) != "") {
		echo "<li id='listItem_".$data['link_id']."' class='tbl2'>\n";
		...
		echo "<a href='".FUSION_SELF.$aidlink."&amp;action=edit&amp;link_id=".$data['link_id']."'><img src='".INFUSIONS."gs_contactform/images/edit.png' alt='" . $locale['444'] . "' title='" . $locale['444'] . "'></img></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
		echo "<a href='".FUSION_SELF.$aidlink."&amp;action=delete&amp;link_id=".$data['link_id']."' onclick=\"return confirm('".$locale['460']."');\"><img src='".INFUSIONS."gs_contactform/images/delete.png' alt='" . $locale['445'] . "' title='" . $locale['445'] . "'></img></a>\n";
		echo "</div>\n";
		...
		echo "<li class='tbl2'>\n";
		echo "<div style='float:left;'>\n";
		echo "<a href='".$linkurl0."'>".$linkname0."</a>\n";
		echo "</div>\n";
		echo "<div style='float:right; width:100px; text-align:center;'>";
		echo "<a href='".FUSION_SELF.$aidlink."&amp;action=new0'>".$locale['gsc151']."</a>";
		echo "</div>\n";
		echo "<div style='float:right; width:200px; text-align:center;'>";
		echo " Link wurde noch nicht gesetzt";
		echo "</div>\n";
		echo "<div style='clear:both;'></div>\n";
		echo "</li>\n";
		}
...
// AGB //
$result = dbquery("SELECT link_id, link_name, link_url, link_visibility, link_order, link_position FROM ".DB_SITE_LINKS." WHERE link_url='infusions/gs_contactform/agb.php'");
$data = dbarray($result);
		
		if (($data['link_name']) != "") {
		echo "<li id='listItem_".$data['link_id']."' class='tbl1'>\n";
		echo "<div style='float:left;'>\n";
		echo "<a href='".BASEDIR.$data['link_url']."'>".parseubb($data['link_name'], "b|i|u|color|img")."</a>\n";
		echo "</div>\n";
		...
		echo "<li class='tbl1'>\n";
		echo "<div style='float:left;'>\n";
		echo "<a href='".$linkurl1."'>".$linkname1."</a>\n";
		echo "</div>\n";
		echo "<div style='float:right; width:100px; text-align:center;'>";
		echo "<a href='".FUSION_SELF.$aidlink."&amp;action=new1'>".$locale['gsc151']."</a>";
		echo "</div>\n";
		echo "<div style='float:right; width:200px; text-align:center;'>";
		echo " Link wurde noch nicht gesetzt";
		echo "</div>\n";
...
// Disclaimer //
$result = dbquery("SELECT link_id, link_name, link_url, link_visibility, link_order, link_position FROM ".DB_SITE_LINKS." WHERE link_url='infusions/gs_contactform/disclaimer.php'");
$data = dbarray($result);
		...
		echo "<li class='tbl2'>\n";
		echo "<div style='float:left;'>\n";
		echo "<a href='".$linkurl2."'>".$linkname2."</a>\n";
		echo "</div>\n";
		echo "<div style='float:right; width:100px; text-align:center;'>";
		echo "<a href='".FUSION_SELF.$aidlink."&amp;action=new2'>".$locale['gsc151']."</a>";
		echo "</div>\n";
		echo "<div style='float:right; width:200px; text-align:center;'>";
		echo " Link wurde noch nicht gesetzt";
		echo "</div>\n";
...
// Impressum //
$result = dbquery("SELECT link_id, link_name, link_url, link_visibility, link_order, link_position FROM ".DB_SITE_LINKS." WHERE link_url='infusions/gs_contactform/impressum.php'");
$data = dbarray($result);
		...
		echo "<li class='tbl1'>\n";
		echo "<div style='float:left;'>\n";
		echo "<a href='".$linkurl3."'>".$linkname3."</a>\n";
		echo "</div>\n";
		echo "<div style='float:right; width:100px; text-align:center;'>";
		echo "<a href='".FUSION_SELF.$aidlink."&amp;action=new3'>".$locale['gsc151']."</a>";
		echo "</div>\n";
		echo "<div style='float:right; width:200px; text-align:center;'>";
		echo " Link wurde noch nicht gesetzt";
		echo "</div>\n";
...
// Über... //
$result = dbquery("SELECT link_id, link_name, link_url, link_visibility, link_order, link_position FROM ".DB_SITE_LINKS." WHERE link_url='infusions/gs_contactform/ueber.php'");
$data = dbarray($result);
		...
		echo "<li class='tbl2'>\n";
		echo "<div style='float:left;'>\n";
		echo "<a href='".$linkurl4."'>".$linkname4."</a>\n";
		echo "</div>\n";
		echo "<div style='float:right; width:100px; text-align:center;'>";
		echo "<a href='".FUSION_SELF.$aidlink."&amp;action=new4'>".$locale['gsc151']."</a>";
		echo "</div>\n";
		echo "<div style='float:right; width:200px; text-align:center;'>";
		echo " Link wurde noch nicht gesetzt";
		echo "</div>\n";
...
opentable('<center>'.$locale['402'].'</center>');
