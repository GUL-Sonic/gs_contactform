...
opentable($locale['gsc306'].": v1.2 => v1.21");

$mysql[] = "UPDATE ".DB_GSC_SETTINGS." SET version='1.21'";

$mysql[] = "UPDATE ".DB_INFUSIONS." SET inf_version='1.21' WHERE inf_folder='gs_contactform'";
