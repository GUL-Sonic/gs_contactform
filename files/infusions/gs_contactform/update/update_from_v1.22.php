...
opentable($locale['gsc306'].": v1.22 => v1.23");

$mysql[] = "ALTER TABLE ".DB_GSC_IMPRESSUM." ADD firm_title_5 varchar(100)";
$mysql[] = "ALTER TABLE ".DB_GSC_IMPRESSUM." ADD firm_field_5 varchar(500)";

$mysql[] = "UPDATE ".DB_GSC_SETTINGS." SET version='1.23'";

$mysql[] = "UPDATE ".DB_INFUSIONS." SET inf_version='1.23' WHERE inf_folder='gs_contactform'";
