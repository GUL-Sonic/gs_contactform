...
opentable($locale['gsc306'].": v1.21 => v1.22");

$mysql[] = "UPDATE ".DB_GSC_SETTINGS." SET version='1.22'";

$mysql[] = "UPDATE ".DB_INFUSIONS." SET inf_version='1.22' WHERE inf_folder='gs_contactform'";
